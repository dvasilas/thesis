...
\noindent
\textbf{Query Parsing.}
The goal of the first phase of query processing is to translate a given query into the internal representations processed by later phases.
...
TODO: techniques similar to those described in the famous paper by Selinger et al. on the System R optimizer.
