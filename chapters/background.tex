...
%  thework presentedin this thesis. It provides an overview of research on key-value stores, includ-ing many orthogonal or complementary research directions.Then it providesan overview of different related research on transactionalsystems. Finally, itprovides an overview of distributed file systems.
...
\subsection{Caching}
% Search engines cache the results of frequent and/or recentqueries to reduce the query workload on backend clustersand improve query response time
...
\medskip
\noindent
\todo{comment on whats the effect on querying}
...
In our prototype
\todo{TODO: ref to implementation chapter}
