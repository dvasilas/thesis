...
\medskip
\noindent
As a result, upon initialization, $index$ $partition_1$ sends the query: \todo{update according to QPU chapter}
...
\noindent
to each downstream Selection QPU, and $index$ $partition_2$ sends the query: \todo{update according to QPU chapter}
...
the unit's callback method discards the materialized entry with the lowest $vote\_count$,
