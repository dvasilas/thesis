...
\bigskip
\noindent
// Helios \cite{potharaju:helios} \todo{discuss Microsoft's Helios. Pushes indexing computations at the edge.}
...
% Data-flow processing was initially invented in the 1970s for circuit design but has recently been adopted for large-scale parallel data-processing in systems

A data-flow system represents computations as a graph;
...
// Naiad \cite{murray:naiad} Dryad \cite{isard:dryad} \todo{discuss Dryad and Naiad}
