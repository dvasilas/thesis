...
instances.
Figure~\ref{fig:qpu_interfaces} shows conceptual depiction of the query processing unit model's interfaces.
...
Figure~\ref{fig:qpu_abstraction} shows conceptual depiction of the query processing unit model.
...
show the domain trees for the QPUs in the ``customers - orders'' example.
...
\textbf{QPU-based query processing systems and ad-hoc queries}.
