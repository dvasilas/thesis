...
Leaf nodes (nodes with no outgoing connections) are always corpus driver QPUs.
...
\begin{itemize}
  \item All QPU graphs mush have corpus driver QPUs as their leaves.
  Corpus drivers generate the initial streams that any other QPU builds on.
