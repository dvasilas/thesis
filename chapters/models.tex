...
\[
  (PrimaryKey,~[Attribute],~Timestamp)
\]
where
\[
...
$PrimaryKey$ is the data item's primary key, $[Attribute]$ is a set of attributes, each represented a name - value pair,
and $Timestamp$ is the timestamp associated with that version.
\end{sloppypar}
