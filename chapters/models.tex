...
However, as described in Section \ref{subsec:query_prcessing_tier} \todo{fix backref}, query results
...
As mentioned in Section \ref{subsec:query_prcessing_tier} \todo{fix backref}, inconsistencies between base data and derived state can lower query
...
\begin{itemize}
  \item \textbf{False positives}: A data item $d$ has been deleted (or updated so that it matches the given query \todo{inverted with negatives}),
